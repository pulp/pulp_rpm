...
COMPONENT_SOURCE="./pulp_rpm/dist/pulp_rpm-${COMPONENT_VERSION}-py3-none-any.whl"
if [ "$TEST" = "s3" ]; then
...
legacy_component_name: "pulp_rpm"
component_name: "rpm"
component_version: "${COMPONENT_VERSION}"
pulp_env: {}
pulp_settings: {"allowed_content_checksums": ["sha1", "sha224", "sha256", "sha512"], "allowed_export_paths": ["/tmp"], "allowed_import_paths": ["/tmp"], "orphan_protection_time": 0, "rpm_publication_cache_duration": 2}
pulp_scheme: "https"
...
image:
  ...
  webserver_snippet: $(test -f pulp_rpm/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_rpm"
    destination: "pulp_rpm"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
