...
if [[ "${RELEASE_WORKFLOW:-false}" == "true" ]]; then
  ...
  REPORTED_VERSION="$(echo $REPORTED_STATUS | jq --arg plugin rpm --arg legacy_plugin pulp_rpm -r '.versions[] | select(.component == $plugin or .component == $legacy_plugin) | .version')"
