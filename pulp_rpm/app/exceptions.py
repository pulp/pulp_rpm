...
class InvalidAdvisoryFileError(PulpException):
    """
    Raised when advisory file is not valid JSON.
    """
    ...
    def __str__(self):
        ...
        Return a message for the exception.
        """
        return f"[{self.error_code}] " + _("JSON file is expected")


class RpmParseError(PulpException):
    """
    Raised when RPM file cannot be parsed for metadata.
    """
    ...
    def __str__(self):
        ...
        Return a message for the exception.
        """
        return f"[{self.error_code}] " + _("RPM file cannot be parsed for metadata")
...
class DuplicateAdvisoryError(PulpException):
    """
    Raised when an advisory already exists in Pulp.
    """

    error_code = "RPM0019"

    def __str__(self):
        return f"[{self.error_code}] " + _("Advisory already exists in Pulp.")
