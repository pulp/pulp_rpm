...
class Solver:
    ...
    def load_source_repo(self, repo_version):
        ...
        """
        self._load_from_version(repo_version)
    ...
    def load_target_repo(self, repo_version):
        ...
        """
        self._load_from_version(repo_version, as_target=True)
    ...
    def _load_from_version(self, repo_version, as_target=False):
        ...
        if as_target:
            ...
            libsolv_repo_name = "source_repo_version ({}, {})".format(
                repo_version.repository, repo_version.number
            )
        ...
        for rpm in nonmodular_rpms:
            pass
            # TODO: Create a solvable for the RPM, register it

            # solvable = rpm_to_solvable(nonmodular_rpms)
    ...
    # def find_dependent_solvables(self, solvables):
