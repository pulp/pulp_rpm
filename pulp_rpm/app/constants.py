...
RPM_PLUGIN_TYPES = SimpleNamespace(PACKAGE="rpm.package", ADVISORY="rpm.advisory")
...
CREATEREPO_UPDATE_COLLECTION_ATTRS = SimpleNamespace(NAME="name", SHORTNAME="shortname")
...
CREATEREPO_UPDATE_REFERENCE_ATTRS = SimpleNamespace(
    HREF="href", ID="id", TITLE="title", TYPE="type"
)
