...
from pulpcore.plugin.serializers import JSONDictField
...
class ModulemdSerializer(NoArtifactContentSerializer):
    ...
    artifacts = JSONDictField(help_text=_("Modulemd artifacts."), allow_null=True)
    dependencies = JSONDictField(help_text=_("Modulemd dependencies."), allow_null=True)
    ...
    profiles = JSONDictField(help_text=_("Modulemd profiles."), allow_null=True)
