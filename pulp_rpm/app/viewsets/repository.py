    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_rpmrepository",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
                "effect": "allow",
                "condition": [
                    "has_remote_param_model_domain_or_obj_perms:rpm.view_rpmremote",
            ...
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.change_rpmrepository",
                    "has_model_domain_or_obj_perms:rpm.view_rpmrepository",
                    "has_remote_param_model_domain_or_obj_perms:rpm.view_rpmremote",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.modify_content_rpmrepository",
                    "has_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_rpmrepository",
                    "has_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.sync_rpmrepository",
                    "has_model_domain_or_obj_perms:rpm.view_rpmrepository",
                    "has_remote_param_model_domain_or_obj_perms:rpm.view_rpmremote",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.manage_roles_rpmrepository",
            },
        ],
        ...
        "statements": [
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_repository_model_domain_or_obj_perms:rpm.view_rpmrepository",
            },
            {
                "action": ["destroy"],
                "principal": "authenticated",
                "effect": "allow",
                "condition": [
                    "has_repository_model_domain_or_obj_perms:rpm.delete_rpmrepository",
                    "has_repository_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                "action": ["destroy"],
                ...
                "effect": "allow",
                "condition": [
                    "has_repository_model_domain_or_obj_perms:rpm.delete_rpmrepository_version",
                    "has_repository_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_repository_model_domain_or_obj_perms:rpm.repair_rpmrepository",
                    "has_repository_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
        ],
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_rpmremote",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
            ...
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.change_rpmremote",
                    "has_model_domain_or_obj_perms:rpm.view_rpmremote",
                ],
            },
            {
                "action": ["destroy"],
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_rpmremote",
                    "has_model_domain_or_obj_perms:rpm.view_rpmremote",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.manage_roles_rpmremote",
            },
        ],
        "queryset_scoping": {"function": "scope_queryset"},
        "creation_hooks": [
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_ulnremote",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
            ...
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.change_ulnremote",
                    "has_model_domain_or_obj_perms:rpm.view_ulnremote",
                ],
            },
            {
                "action": ["destroy"],
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_ulnremote",
                    "has_model_domain_or_obj_perms:rpm.view_ulnremote",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.manage_roles_ulnremote",
            },
        ],
        "queryset_scoping": {"function": "scope_queryset"},
        "creation_hooks": [
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_rpmpublication",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
                ...
                "condition": [
                    ...
                    "has_repo_attr_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                "action": ["destroy"],
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_rpmpublication",
                    "has_model_domain_or_obj_perms:rpm.view_rpmpublication",
                ],
            },
            {
                "action": ["list_roles", "add_role", "remove_role"],
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.manage_roles_rpmpublication",
            },
        ],
        "queryset_scoping": {"function": "scope_queryset"},
        "creation_hooks": [
    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_rpmdistribution",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
                ...
                "condition": [
                    ...
                    "has_publication_param_model_domain_or_obj_perms:rpm.view_rpmpublication",
                    "has_repo_attr_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.change_rpmdistribution",
                    "has_model_domain_or_obj_perms:rpm.view_rpmdistribution",
                    "has_publication_param_model_domain_or_obj_perms:rpm.view_rpmpublication",
                    "has_repo_attr_model_domain_or_obj_perms:rpm.view_rpmrepository",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_rpmdistribution",
                    "has_model_domain_or_obj_perms:rpm.view_rpmdistribution",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.manage_roles_rpmdistribution",
            },
        ],
        "queryset_scoping": {"function": "scope_queryset"},
        "creation_hooks": [
