    ...
    DEFAULT_ACCESS_POLICY = {
        "statements": [
            ...
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:rpm.view_rpmalternatecontentsource",
            },
            {
                "action": ["create"],
                "principal": "authenticated",
                ...
                "condition": [
                    ...
                    "has_model_domain_perms:rpm.add_rpmalternatecontentsource",
                ],
            },
            {
                "action": ["refresh"],
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.view_rpmalternatecontentsource",
                    "has_model_domain_perms:rpm.refresh_rpmalternatecontentsource",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.change_rpmalternatecontentsource",
                    "has_model_domain_or_obj_perms:rpm.view_rpmalternatecontentsource",
                    "has_remote_param_model_domain_or_obj_perms:rpm.view_rpmremote",
                ],
            },
            {
                ...
                "effect": "allow",
                "condition": [
                    "has_model_domain_or_obj_perms:rpm.delete_rpmalternatecontentsource",
                    "has_model_domain_or_obj_perms:rpm.view_rpmalternatecontentsource",
                ],
            },
            {
                ...
                "principal": "authenticated",
                "effect": "allow",
                "condition": "has_model_domain_or_obj_perms:"
