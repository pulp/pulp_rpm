...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Category',
            fields=[
                ('content_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='rpm_category', serialize=False, to='core.Content')),
        ...
        migrations.CreateModel(
            name='Environment',
            fields=[
                ('content_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='rpm_environment', serialize=False, to='core.Content')),
                ('id', models.CharField(max_length=255)),
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField()),
                ('display_order', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='Langpacks',
            fields=[
                ('content_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='rpm_langpacks', serialize=False, to='core.Content')),
