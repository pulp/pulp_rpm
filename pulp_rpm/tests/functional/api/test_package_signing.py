...
def test_signing_fingerprint_label_on_upload(
    tmp_path,
    monitor_task,
    signing_gpg_metadata,
    rpm_package_signing_service,
    ...
    """Test that RPM_SIGNING_FINGERPRINT_LABEL is set on the package when uploaded with signing."""
    if settings.RPM_SIGNING_FINGERPRINT_LABEL != "signing_fingerprint":
        pytest.skip("RPM_SIGNING_FINGERPRINT_LABEL must be set to 'signing_fingerprint'")
    ...
    assert package.pulp_labels.get("signing_fingerprint") == fingerprint


def test_signing_fingerprint_label_on_modify(
    monitor_task,
    pulpcore_bindings,
    signing_gpg_metadata,
    rpm_package_signing_service,
    ...
    """Test that RPM_SIGNING_FINGERPRINT_LABEL is set on the package when added via modify."""
    if settings.RPM_SIGNING_FINGERPRINT_LABEL != "signing_fingerprint":
        pytest.skip("RPM_SIGNING_FINGERPRINT_LABEL must be set to 'signing_fingerprint'")
    ...
    assert signed_package.pulp_labels.get("signing_fingerprint") == fingerprint
