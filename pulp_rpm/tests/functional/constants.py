...
RPM_MODULAR_OBSOLETE_COUNT = 6
"""The number of modulemd-obsoletes present on `RPM_MODULAR_FIXTURE_URL`."""
...
RPM_MODULAR_OBSOLETES_CONTENT_NAME = "rpm.modulemd_obsolete"
...
RPM_MODULAR_FIXTURE_SUMMARY = {
    ...
    RPM_MODULAR_OBSOLETES_CONTENT_NAME: RPM_MODULAR_OBSOLETE_COUNT,
