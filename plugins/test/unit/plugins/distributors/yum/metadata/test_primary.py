...
class PrimaryXMLFileContextTests(unittest.TestCase):
    ...
    def test_initialize_fast_forward(self):
        ...
        node = mock.Mock(nodeName='metadata', attributes={'packages': mock.Mock(value='2')})
        end_node = mock.Mock(nodeName='metadata')
        node2 = mock.Mock(nodeName='metadata', attributes={'packages': mock.Mock(value='2')})
